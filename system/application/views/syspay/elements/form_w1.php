...
$desc		= "Пополнение счета пользователем №{$user->user_id} на сумму $green у.е.";
...
$fields["WMI_SUCCESS_URL"]		= W1_SUCCESS_URL;
$fields["WMI_FAIL_URL"]			= W1_FAIL_URL;
$fields["WMI_AUTO_ACCEPT"]		= "0";
$fields["User_id"]				= $user->user_id;
$fields["User_amount"]			= $green;
$fields["User_tax"]				= $User_tax;
