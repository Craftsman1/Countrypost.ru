<form method="POST" action="https://merchant.webmoney.ru/lmi/payment.asp" name="postform">
	...
	LMI_PAYMENT_DESC:<input type="text" name="LMI_PAYMENT_DESC" value="Charge for user <?=$user->user_id;?> (on sum: <?=$green?>)"><br />
	...
	User_amount:<input type="text" name="User_amount" value="<?=$green?>"><br />
