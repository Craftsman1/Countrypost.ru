<div class='header'>
	<h1 class='logo'>
		<a href='<?= $this->config->item('base_url') ?>'>ContryPost - Лучший сервис покупок за рубежом</a>
	</h1>
	<ul class='menu'>
		<li><a href='<?= $this->config->item('base_url') ?>main/showHowItWork'>Как это работает</a></li>
		<li><a href='<?= $this->config->item('base_url') ?>main/showPricelist'>Тарифы</a></li>
		<li><a href='<?= $this->config->item('base_url') ?>syspay/showPays'>Способы оплаты</a></li>
