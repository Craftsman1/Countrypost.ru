...
<script>
	...
	$('td#odetail_id<?= $odetail->odetail_id?>')
		.addClass('red-color')
		.attr('title', 'Товар изменен клиентом');
	<? else : ?>
	$('td#odetail_id<?= $odetail->odetail_id?>')
