<form action="/manager/savePricelist" id="pricelistForm" method="POST">
	<div class="pricelist pricelist_main table dealer_tab" style="display:none;">
		...
		<div>
			...
			<span>
				...
				$manager->order_mail_forwarding_tax ?>" /> <?= $manager->statistics->currency ?> (Mail Forwarding)
			</span>
		</div>
		<div>
			<span>
	...
	<div class="pricelist dealer_tab" style="display:none;">
		...
		<div class="table">
			...
			<div class='angle angle-lb'></div>
			<div class='angle angle-rb'></div>
			<textarea id='pricelist_message' name="pricelist_message" style="width: 920px; height: 200px;"><?= empty
