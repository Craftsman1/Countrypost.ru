<div class='step-by-step'>
	<p style="text-align: justify;">
		<b>Countrypost</b> – поможет Вам легко и быстро купить и доставить любой товар из любых online или offline магазинов Китая, Австрии, Венгрии и всей Европы. <br />
			
			<span style="margin-left: 10px;">1. <a href="/main/createorder">Добавьте</a> заказ на покупку из любого магазина Европы или Китая у нас на сайте;</span><br />
			<span style="margin-left: 10px;">2. Дождитесь обработки и подсчета итоговой стоимости заказа;</span><br />
			<span style="margin-left: 10px;">3. Оплатите заказ одним из 12 удобных способов оплаты.</span><br />
			<span style="margin-left: 10px;">4. Как только заказ будет собран через один день его можно будет забрать в Москве.</span><br />
	</p>
