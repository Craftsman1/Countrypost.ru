 ...
 *
 */
class FaqSectionModel extends BaseModel implements IModel{

	protected 	$properties			= null;			// array of properties
	protected	$table				= 'faq_section';		// table name
	protected	$PK					= 'faq_section_id';		// primary key name	
	...
	function __construct()
    {
    	...
    	$this->properties->faq_section_name ='';
    	$this->properties->is_default ='';
