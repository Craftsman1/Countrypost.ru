...
define('PB_IN_ACCOUNT_USD', '6762462619290692');
define('PB_IN_ACCOUNT_UAH', '6762462619373001');
define('PB_SERVICE_NAME', 'Приват Банк (Украина)');
define('PB_SERVICE_DESCRIPTION', 'Оплата через Приват Банк (Украина)');
